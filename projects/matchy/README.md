...
**from now on i will say inspect instead of console.log**
 ...
 6. [x ] inspect `animals`. What does it look like?
 ...
 8. [x ] inspect `animals`.
 9. [x ] inspect the length of `animals`
 10. [ x] Is everything looking right?
...
## Step 5 - Break
**Step back and think about how far you've come!!** We are doing really hard stuff**
**and if you've gotten here you get it! This is awesome! It means you are well on your way to becoming a **pro web developer**. SWEET!
